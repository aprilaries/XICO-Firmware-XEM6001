...
xst -ifn xst.scr
move PULSE_CLK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PULSE_CLK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PULSE_CLK_exdes.ucf PULSE_CLK_exdes

echo 'Running map'
map -timing -pr b PULSE_CLK_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PULSE_CLK_exdes -w routed.ncd routed.v
cd ..
