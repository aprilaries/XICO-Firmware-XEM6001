...
vlog -work work CLK_MNGR_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax CLK_MNGR_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.CLK_MNGR_tb work.glbl
