...
vlog -work work pll2x_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax pll2x_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.pll2x_tb work.glbl
